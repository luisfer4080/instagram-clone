...
export default function Reels({handdleActive,active,showText}){

    return (
        <div>
            <span className='header__menu__element'>
                <div className="header__menu__relative" onClick={() => handdleActive(4)}>
                            ...
                            <div>
                                <div className="menu__element__link__svg__container">
                                    <div className="menu__element__link__svg">
                                        { active ? 
                                            (
                                                <svg aria-label='Reels' className='menu__element__link__svg__display' color='rgb(0,0,0)' fill='rgb(0,0,0)' height="24px" width="24px" viewBox='0 0 24 24' role='img'>
