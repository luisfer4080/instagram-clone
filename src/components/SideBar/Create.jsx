...
export default function Create({handdleActive,active,showText}){
    return(
        <div>
            <div className='header__menu__relative'>
                <span className='header__menu__element'>
                    <div className='header__menu__relative' onClick={() => handdleActive(7)}>
                                ...
                                <div>
                                    <div className='menu__element__link__svg__container'>
                                        <div className='menu__element__link__svg'>
                                            { active ? 
                                                (
                                                    <svg aria-label='New post' className='menu__element__link__svg__display' color='rgb(0,0,0)' fill='rgb(0,0,0)' height="24px" width="24px" viewBox='0 0 24 24' role='img'>
